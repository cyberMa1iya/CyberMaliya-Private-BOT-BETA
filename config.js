...
module.exports = {
    ...
    MEN: process.env.MENU_CMD === undefined ? 'MALIYAH' : process.env.MENU_CMD,
    SESSION: process.env.MALIYAH_SESSION === undefined ? '' : process.env.MALIYAH_SESSION,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'MALIYAH' : process.env.OWNER_NAME,
    ...
    GROUPN1: process.env.GROUP_DETAILS === undefined ? 'MALIYAH OFFICIAL SUPPORT': process.env.GROUP_DETAILS,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/GT5V8RakkftB7DAKWMeQML': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'MALIYAH OFFICIAL TEST': process.env.GROUP_NAME_2,
    ...
    CAPTION: process.env.CAPTION === undefined ? ' ⎝🛡️ MALIYAH 🛡️⎠ ' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'MALIYAH' : process.env.BOT_NAME,
    ...
    MALIYAH: process.env.MALIYAH === undefined ? 'MALIYAH' : process.env.MALIYAH,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'MALIYAH' : process.env.TAG_HEADER,
