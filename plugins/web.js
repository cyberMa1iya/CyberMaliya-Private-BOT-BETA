...
Trex.addrex({pattern: 'speedtest', fromMe: true,  deleteCommand: false,  desc: Lang.SPEEDTEST_DESC}, (async (message, match) => {
...
Trex.addrex({pattern: 'ping', fromMe: true,  deleteCommand: false, desc: Lang.PING_DESC}, (async (message, match) => {
